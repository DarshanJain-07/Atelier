...
def test_r0_basic_reproduction():
    ...
    print(f"Super-spreaders (R0≥5): {super_spreaders} out of {num_seeds} seeds ({super_spreaders/num_seeds*100:.1f}%)")
    ...
    print(f"Correlation between Thought Extremity and R0: {corr:.3f} (p-value: {p_val:.4f})")
